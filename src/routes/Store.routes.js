...
import { DeleteStore, GetAllStore, GetPersonalStore, GetStore, UpdateStore, addStore } from "../controllers/Store.controller.js";
const router=Router();
...
router.route("/getpersonalStore").get(verifyJWT  , GetPersonalStore);
